...
#include <memory>
#include "../../cncSoftware/src/websocket/websocket.h"
...
QT_MOC_LITERAL(1, 10, 21), // "signal_RequestCommand"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 7), // "command"
QT_MOC_LITERAL(4, 41, 4) // "type"

    },
    "Websocket\0signal_RequestCommand\0\0"
    "command\0type"
};
...
void Websocket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signal_RequestCommand((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Websocket::*)(QString , QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Websocket::signal_RequestCommand)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Websocket::signal_RequestCommand(QString _t1, QString _t2)
{
